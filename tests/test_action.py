...
from tests.actions.foo import Foo
from tests.actions.bar import Bar
from tests.actions.baz import Baz
from pydantic import ValidationError
from core.actions import ActionRegistry
from tests.actions.foobarbaz import FooBarBaz, Foo as FBBFoo, Bar as FBBBar, Baz as FBBBaz
...
class TestAction(unittest.TestCase):
    ...
    def test_foo_bar_baz(self):
        foobarbaz = FooBarBaz(
            foo = FBBFoo(foo = "Hello", bar = "World"),
            bar = FBBBar(foo = "Hello", bar = "World"),
            baz = FBBBaz()
        )
    ...
    def test_action_registry(self):
        path = "tests/actions"
        actions = ActionRegistry.actions(path = path)
        json = ActionRegistry.json(path = path)
        expected_actions = {'Foo': Foo, 'Bar': Bar, 'Baz': Baz, 'FooBarBaz': FooBarBaz}
        expected_json = """{"Foo": {"description": "This is a Foo test action", "fields": {"foo": {"type": "string", "description": "The foo value", "default": "Foo"}, "bar": {"type": "string", "description": "The bar value", "default": "Bar"}}}, "Baz": {"description": "This is a Baz test action", "fields": {"foo": {"type": "string", "description": "The foo value", "default": null}, "bar": {"type": "string", "description": "The bar value", "default": null}}}, "FooBarBaz": {"description": "This is a FooBarBaz test action", "fields": {"foo": {"type": "Foo", "description": "This is a Foo test action", "fields": {"foo": {"type": "string", "description": "The foo value", "default": "Foo"}, "bar": {"type": "string", "description": "The bar value", "default": "Bar"}}}, "bar": {"type": "Bar", "description": "This is a Bar test action", "fields": {"foo": {"type": "string", "description": "The foo value"}, "bar": {"type": "string", "description": "The bar value"}}}, "baz": {"type": "Baz", "description": "This is a Baz test action", "fields": {"foo": {"type": "string", "description": "The foo value", "default": null}, "bar": {"type": "string", "description": "The bar value", "default": null}}}, "hello": {"type": "string", "description": "The hello value", "default": "Hello"}, "world": {"type": "string", "description": "The world value", "default": "World"}}}, "Bar": {"description": "This is a Bar test action", "fields": {"foo": {"type": "string", "description": "The foo value"}, "bar": {"type": "string", "description": "The bar value"}}}}"""
