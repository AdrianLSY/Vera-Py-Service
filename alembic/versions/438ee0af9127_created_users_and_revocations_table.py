"""created users and revocations table

Revision ID: 438ee0af9127
Revises:
Create Date: 2025-09-15 15:03:00.203822
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_revocations_jti'), 'revocations', ['jti'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_table('users')
    op.drop_index(op.f('ix_revocations_jti'), table_name='revocations')
